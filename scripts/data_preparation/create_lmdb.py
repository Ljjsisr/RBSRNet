...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    folder_path = r'E:\PycharmProjects\SR\BasicSR-master\datasets\DIV2K\DIV2K_train_HR_sub'  # 输入图像文件夹的路径
    lmdb_path = 'E:\PycharmProjects\SR\BasicSR-master\datasets\DIV2K\DIV2K_train_HR_sub.lmdb'  # 输出 LMDB 文件的路径
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    folder_path = r'E:\PycharmProjects\SR\BasicSR-master\datasets\DIV2K\DIV2K_train_LR_bicubic\X2_sub'
    lmdb_path = 'E:\PycharmProjects\SR\BasicSR-master\datasets\DIV2K\DIV2K_train_LR_bicubic_X2_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    folder_path = r'E:\PycharmProjects\SR\BasicSR-master\datasets\DIV2K\DIV2K_train_LR_bicubic\X3_sub'
    lmdb_path = 'E:\PycharmProjects\SR\BasicSR-master\datasets\DIV2K\DIV2K_train_LR_bicubic_X3_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    folder_path = r'E:\PycharmProjects\SR\BasicSR-master\datasets\DIV2K\DIV2K_train_LR_bicubic\X4_sub'
    lmdb_path = 'E:\PycharmProjects\SR\BasicSR-master\datasets\DIV2K\DIV2K_train_LR_bicubic_X4_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
if __name__ == '__main__':
    ...
    # 使用了 argparse 模块来解析命令行参数，并根据不同的参数值执行不同的函数
    parser.add_argument(
        '--dataset',
        type=str,
